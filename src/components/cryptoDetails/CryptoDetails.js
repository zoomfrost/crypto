...
import { cryptoTimePeriodChanged } from '../../slices/cryptoSlice';
...
const CryptoDetails = () => {
    ...
    const timePeriod = useSelector(state => state.crypto.timePeriod);
    ...
    const genericStats = [
        ...
        { title: 'Total Supply', value: cryptoDetails.supply.total ? `$ ${millify(cryptoDetails.supply.total)}` : 'no info', icon: <ExclamationCircleOutlined /> },
        ...
        <>
            <Helmet>
                <meta
                    ...
                    content="details"
                    />
                <title>{cryptoDetails.name} details</title>
            </Helmet>
            <Col className='coin-detail-container'>
                ...
                <Select 
                    ...
                    onChange={(value) => dispatch(cryptoTimePeriodChanged(value))}
                >
